		...
		createButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				EmployeePayrollDetailsRepository.addEmployeePayrollDetails(new EmployeePayrollDetails(0, employeeRecord, departmentText.getText(),
						(sickLeavesText.getText()!=null?Double.parseDouble(sickLeavesText.getText()):0.0), 
						(casualLeavesText.getText()!=null?Double.parseDouble(casualLeavesText.getText()):0.0),
						(annualLeavesText.getText()!=null?Double.parseDouble(annualLeavesText.getText()):0.0),
						(studyLeavesText.getText()!=null?Double.parseDouble(studyLeavesText.getText()):0.0),
						(otherText.getText()!=null?Double.parseDouble(otherText.getText()):0.0),
						(daysOfLeavesText.getText()!=null?Double.parseDouble(daysOfLeavesText.getText()):0.0),
						(Date)leaveStartDatePicker.getModel().getValue(), (Date)leaveEndDatePicker.getModel().getValue(),
						loanNameText.getText(), 
						(intertestRateText.getText()!=null?Double.parseDouble(intertestRateText.getText()):0.0),
						gradeLevelText.getText(),
						(allowancesText.getText()!=null?Double.parseDouble(allowancesText.getText()):0.0),
						(initialSalaryText.getText()!=null?Double.parseDouble(initialSalaryText.getText()):0.0),
						(upgradeSalaryText.getText()!=null?Double.parseDouble(upgradeSalaryText.getText()):0.0),
