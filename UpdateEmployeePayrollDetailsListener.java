	...
	public void createAndShowGUI() {
		...
		updateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				employeePayrollDetails.setSickLeaves((sickLeavesText.getText()!=null?Double.parseDouble(sickLeavesText.getText()):0.0));
				employeePayrollDetails.setCasualLeaves((casualLeavesText.getText()!=null?Double.parseDouble(casualLeavesText.getText()):0.0));
				employeePayrollDetails.setAnnualLeaves((annualLeavesText.getText()!=null?Double.parseDouble(annualLeavesText.getText()):0.0));
				employeePayrollDetails.setStudyLeaves((studyLeavesText.getText()!=null?Double.parseDouble(studyLeavesText.getText()):0.0));
				employeePayrollDetails.setOther((otherText.getText()!=null?Double.parseDouble(otherText.getText()):0.0));
				employeePayrollDetails.setDaysOfLeaves((daysOfLeavesText.getText()!=null?Double.parseDouble(daysOfLeavesText.getText()):0.0));
				...
				employeePayrollDetails.setIntertestRate((intertestRateText.getText()!=null?Double.parseDouble(intertestRateText.getText()):0.0));
				employeePayrollDetails.setGradeLevel(gradeLevelText.getText());
				employeePayrollDetails.setAllowances((allowancesText.getText()!=null?Double.parseDouble(allowancesText.getText()):0.0));
				employeePayrollDetails.setInitialSalary((initialSalaryText.getText()!=null?Double.parseDouble(initialSalaryText.getText()):0.0));
				employeePayrollDetails.setUpgradeSalary((upgradeSalaryText.getText()!=null?Double.parseDouble(upgradeSalaryText.getText()):0.0));
