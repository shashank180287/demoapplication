...
public class AddNewVendorCategoryListener extends JFrame implements StockManagerActionListener {
	/**
	 * 
	 */
	...
	public AddNewVendorCategoryListener(AdminRoleMouseListener listener)
	...
	public void createAndShowGUI() {
		...
		createButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				VendorCategory vendorCategory = new VendorCategory(0, nameText.getText(), descriptionText.getText());
				VendorCategoryRepository.addVendorCategoryDetails(vendorCategory);
