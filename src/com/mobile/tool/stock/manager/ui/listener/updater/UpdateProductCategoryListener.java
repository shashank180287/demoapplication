...
public class UpdateProductCategoryListener extends JFrame implements StockManagerActionListener {
	/**
	 * 
	 */
	...
	public UpdateProductCategoryListener(StockManagementTableModel tableModel,
			...
			String descStr = (desc!=null)?desc.toString():"";
				...
				updateButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						ProductCatagory productCatagory = new ProductCatagory(Integer.parseInt(idStr), nameText.getText(), descriptionText.getText());
						ProductCategoryRepository.updateProductCategoryDetails(productCatagory);
