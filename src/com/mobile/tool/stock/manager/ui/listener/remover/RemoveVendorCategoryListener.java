...
public class RemoveVendorCategoryListener  extends JFrame implements StockManagerActionListener {
	/**
	 * 
	 */
	...
	public RemoveVendorCategoryListener(StockManagementTableModel tableModel,
	...
	public void createAndShowGUI() {
		if(table.getSelectedRow()!=-1){
			...
			if(dialogResult == JOptionPane.YES_OPTION){
				VendorCategoryRepository.removeVendorCategoryDetails(Integer.parseInt(idStr));
