...
public class DynamicReportDesign {
	private DynamicReportData data;

	public DynamicReportDesign(DynamicReportData data) {
		this.data = data;
	}
	...
	public static void main(String[] args) {
		DynamicReportDesign design = new DynamicReportDesign(new DynamicReportData());
		try {
